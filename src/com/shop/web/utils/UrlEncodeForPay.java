...
public class UrlEncodeForPay {
	...
	public static String enCodingForPay(String string, String key, String enc) {
        String returnString = "";
        try {
        	
            byte[] _encrypt = ThreeDES.encryptMode(key.getBytes(), string.getBytes());
            returnString = parseByte2HexStr(_encrypt);
        } catch (Exception e) {
            returnString = "wrong";
        }
        return returnString;
